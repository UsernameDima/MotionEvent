...
public class Swipe extends FrameLayout {
    @Deprecated
    ...
    public Swipe(Context context, AttributeSet attrs, int defStyle) {
    ...
    public interface SwipeListener {
        public void onStartOpen(Swipe layout);

        public void onOpen(Swipe layout);

        public void onStartClose(Swipe layout);

        public void onClose(Swipe layout);

        public void onUpdate(Swipe layout, int leftOffset, int topOffset);

        public void onHandRelease(Swipe layout, float xvel, float yvel);
    }
    ...
    private ViewDragHelper.Callback mDragHelperCallback = new ViewDragHelper.Callback() {
        ...
        public void onViewReleased(View releasedChild, float xvel, float yvel) {
            ...
            for (SwipeListener l : mSwipeListeners){
                l.onHandRelease(Swipe.this, xvel, yvel);
            }
    ...
    protected void dispatchSwipeEvent(int surfaceLeft, int surfaceTop, boolean open) {
        ...
        if (!mSwipeListeners.isEmpty()) {
            ...
            for (SwipeListener l : mSwipeListeners) {
                ...
                l.onUpdate(Swipe.this, surfaceLeft - getPaddingLeft(), surfaceTop - getPaddingTop());
            }

            if (status == Status.Close) {
                for (SwipeListener l : mSwipeListeners) {
                    l.onClose(Swipe.this);
                }
                mEventCounter = 0;
            }
    ...
    private void performAdapterViewItemClick() {
        ...
        if (t instanceof AdapterView) {
            ...
            int p = view.getPositionForView(Swipe.this);
    ...
    private boolean performAdapterViewItemLongClick() {
        ...
        if (t instanceof AdapterView) {
            ...
            try {
                ...
                handled = (boolean) m.invoke(view, Swipe.this, p, vId);

            } catch (Exception e) {
                e.printStackTrace();

                if (view.getOnItemLongClickListener() != null) {
                    handled = view.getOnItemLongClickListener().onItemLongClick(view, Swipe.this, p, vId);
                }
                if (handled) {
    ...
    class SwipeDetector extends GestureDetector.SimpleOnGestureListener {
        ...
        public boolean onDoubleTap(MotionEvent e) {
            if (mDoubleClickListener != null) {
                ...
                mDoubleClickListener.onDoubleClick(Swipe.this, target == surface);
            }
            return true;
        }
    }
    ...
    public interface DoubleClickListener {
        public void onDoubleClick(Swipe layout, boolean surface);
    }
